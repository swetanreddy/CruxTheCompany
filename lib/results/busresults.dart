...
import 'package:com/CompanyProfiles/busprofile.dart';
...
class busResults extends StatefulWidget {
  busResults({Key key, this.city, this.purpose}) : super(key: key);
  final String city, purpose;
  @override
  _AppState createState() => _AppState();
}

class _AppState extends State<busResults> {
                                ...
                                onTap: () {
                                  Navigator.push(context,
                                    MaterialPageRoute(builder:
                                        (context) => BusProfile(companyName:doc.data["CompanyName"],city: doc.data["City"],  purpose: 'price quotation')),
                                  );
                                },
                                child: ListTile(
