...
import 'package:com/CompanyProfiles/cabprofile.dart';
...
class cabResults extends StatefulWidget {
  cabResults({Key key, this.city, this.purpose}) : super(key: key);
  final String city, purpose;
  @override
  _AppState createState() => _AppState();
}

class _AppState extends State<cabResults> {
                                ...
                                onTap: () {
                                  Navigator.push(context,
                                    MaterialPageRoute(builder:
                                        (context) => CabProfile(companyName:doc.data["CompanyName"],city: doc.data["City"],  purpose: 'price quotation')),
                                  );
                                },
                                child: ListTile(
