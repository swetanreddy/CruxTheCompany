...
class CabProfile extends StatefulWidget {
  ...
  CabProfile({Key key, this.city, this.purpose, this.companyName, this.location, this.Services}) : super(key: key);
  // ignore: non_constant_identifier_names
...
class _AppState extends State<CabProfile> {
